-- M2 T1: ad accounts, tests, campaigns, ad variants, autopilot log.
...
create index on public.ad_accounts (user_id);
create index on public.tests (project_id);
create index on public.campaigns (test_id);
create index on public.ad_variants (test_id);
create index on public.autopilot_actions (test_id);